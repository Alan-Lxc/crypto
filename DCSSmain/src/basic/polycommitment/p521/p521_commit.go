...
func NewPolyCommit(polynomial poly.Poly) PolyCommit {
	allCoeff := polynomial.GetAllCoeff()
...
func (comm PolyCommit) Verify(poly poly.Poly) bool {
	allCoeff := poly.GetAllCoeff()
